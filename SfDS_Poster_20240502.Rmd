...
knitr::kable(test_results, 
             ...
             align = "c", col.names = c("Test", "P_Value", "H0", "Conclusion"), 
             escape = TRUE)
```
...
model_results <- data.frame(
  ...
  Females = c(summary(pooled_ols)$coefficients["log(Number_of_Females + 1)", "Pr(>|t|)"],
           summary(fixed_effects)$coefficients["log(Number_of_Females + 1)", "Pr(>|t|)"],
           summary(random_effects)$coefficients["log(Number_of_Females + 1)", "Pr(>|z|)"],
           pooled_ols_robust["log(Number_of_Females + 1)", "Pr(>|t|)"],
           fixed_effects_robust["log(Number_of_Females + 1)", "Pr(>|t|)"],
           random_effects_robust["log(Number_of_Females + 1)", "Pr(>|t|)"]),
  Males = c(summary(pooled_ols)$coefficients["log(Number_of_Males + 1)", "Pr(>|t|)"],
             summary(fixed_effects)$coefficients["log(Number_of_Males + 1)", "Pr(>|t|)"],
             summary(random_effects)$coefficients["log(Number_of_Males + 1)", "Pr(>|z|)"],
             pooled_ols_robust["log(Number_of_Males + 1)", "Pr(>|t|)"],
             fixed_effects_robust["log(Number_of_Males + 1)", "Pr(>|t|)"],
             random_effects_robust["log(Number_of_Males + 1)", "Pr(>|t|)"]),
  Survivors = c(summary(pooled_ols)$coefficients["log(Number_of_Survivors + 1)", "Pr(>|t|)"],
                summary(fixed_effects)$coefficients["log(Number_of_Survivors + 1)", "Pr(>|t|)"],
                summary(random_effects)$coefficients["log(Number_of_Survivors + 1)", "Pr(>|z|)"],
                pooled_ols_robust["log(Number_of_Survivors + 1)", "Pr(>|t|)"],
                fixed_effects_robust["log(Number_of_Survivors + 1)", "Pr(>|t|)"],
                random_effects_robust["log(Number_of_Survivors + 1)", "Pr(>|t|)"]),
  Drowning = c(summary(pooled_ols)$coefficients["Drowning", "Pr(>|t|)"],
               summary(fixed_effects)$coefficients["Drowning", "Pr(>|t|)"],
               summary(random_effects)$coefficients["Drowning", "Pr(>|z|)"],
               pooled_ols_robust["Drowning", "Pr(>|t|)"],
               fixed_effects_robust["Drowning", "Pr(>|t|)"],
               random_effects_robust["Drowning", "Pr(>|t|)"])
)
