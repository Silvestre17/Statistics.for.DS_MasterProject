...
```{r myprettycode, echo=FALSE, fig.cap='<span class="caption-text">Boxplots, message=FALSE, warning=FALSE, out.width="95%", so hot right now!</span>', fig.height=7}
# ------------------------------------
### Polar Charts ###
...
# Convertendo os valores para caracteres para melhor formatação
test_results$P_Value <- sprintf("%.4g", test_results$P_Value)
...
```{r}
# Extraindo os resultados dos modelos
model_results <- data.frame(
  Model = c("Pooled OLS", "Fixed Effects", "Random Effects", "Robust Pooled", "Robust Fixed Effects", "Robust Random Effects"),
  Females = c(summary(pooled_ols)$coefficients["log(Number_of_Females + 1)", "Estimate"],
           summary(fixed_effects)$coefficients["log(Number_of_Females + 1)", "Estimate"],
           summary(random_effects)$coefficients["log(Number_of_Females + 1)", "Estimate"],
           pooled_ols_robust["log(Number_of_Females + 1)", "Estimate"],
           fixed_effects_robust["log(Number_of_Females + 1)", "Estimate"],
           random_effects_robust["log(Number_of_Females + 1)", "Estimate"]),
  Males = c(summary(pooled_ols)$coefficients["log(Number_of_Males + 1)", "Estimate"],
             summary(fixed_effects)$coefficients["log(Number_of_Males + 1)", "Estimate"],
             summary(random_effects)$coefficients["log(Number_of_Males + 1)", "Estimate"],
             pooled_ols_robust["log(Number_of_Males + 1)", "Estimate"],
             fixed_effects_robust["log(Number_of_Males + 1)", "Estimate"],
             random_effects_robust["log(Number_of_Males + 1)", "Estimate"]),
  Survivors = c(summary(pooled_ols)$coefficients["log(Number_of_Survivors + 1)", "Estimate"],
                summary(fixed_effects)$coefficients["log(Number_of_Survivors + 1)", "Estimate"],
                summary(random_effects)$coefficients["log(Number_of_Survivors + 1)", "Estimate"],
                pooled_ols_robust["log(Number_of_Survivors + 1)", "Estimate"],
                fixed_effects_robust["log(Number_of_Survivors + 1)", "Estimate"],
                random_effects_robust["log(Number_of_Survivors + 1)", "Estimate"]),
  Drowning = c(summary(pooled_ols)$coefficients["Drowning", "Estimate"],
               summary(fixed_effects)$coefficients["Drowning", "Estimate"],
               summary(random_effects)$coefficients["Drowning", "Estimate"],
               pooled_ols_robust["Drowning", "Estimate"],
               fixed_effects_robust["Drowning", "Estimate"],
               random_effects_robust["Drowning", "Estimate"])
)

model_results$Females <- sprintf("%.3g", as.numeric(model_results$Females))
model_results$Males <- sprintf("%.3g", as.numeric(model_results$Males))
model_results$Survivors <- sprintf("%.3g", as.numeric(model_results$Survivors))
model_results$Drowning <- sprintf("%.3g", as.numeric(model_results$Drowning))
